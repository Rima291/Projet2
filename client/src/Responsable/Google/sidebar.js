    ...
    return (
        <div className="sidebar">
            <div className="top">
                ...
                <div >
            <img src={HelpIcon} alt="" onClick={handleQuestionMarkClick} style={{ height:'20px' , marginBottom:'-860px', marginTop:'100px' }} />
            {extended ? <p style={{marginLeft:'30px' , marginTop:'457px'}}>Aide</p> : null}
