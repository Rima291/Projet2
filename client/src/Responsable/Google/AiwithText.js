...
const AiwithImageAndText = () => {
    ...
    return (
        <div className="main" >
            <div className="nav">
                <p style={{marginLeft:'25px' , marginTop:'-20px'}}>Gemini</p>
                <img src={UserIcon} alt="" style={{ marginTop: '-50px', marginLeft: '1050px' }} />
            </div>
            <div className="main-container">
                {!searched && (
                    <div className="greet">
                        <p><span>Bonjour, Dev.</span></p>
                ...
                <div ref={responseContainerRef} style={{ overflowY: 'scroll', maxHeight: '350px', border: 'none', padding: '30px', marginTop:'-10px'  }}>
                
                {responses.map((response, index) => (
                    <div key={index}>
                        <div style={{ display: 'flex', alignItems: 'center'  }}>
                            {response.image && <img src={response.image} alt="Response Image" style={{ width: '50px', height: '50px', marginRight: '25px', marginTop:'-40px' }} />}
                            <div style={{ marginLeft: response.image ? '10px' : '0' }}>
                                <img src={geminiIcon} alt="" className="loadingIcon" style={{ width: '25px', height: '25px', marginTop: '80px', marginBottom: '-25px' , marginLeft:'-28px' }} />
                                {response.text.split('\n').map((line, index) => (
